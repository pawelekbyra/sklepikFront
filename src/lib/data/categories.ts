...
import type { CategoryListParams, PaginatedResponse, Product, ProductListParams } from '@spree/sdk'
...
export async function getCategory(idOrPermalink: string, params?: { expand?: string[] }) {
...
async function cachedListCategoryProducts(
  ...
  return getClient().products.list({ ...params, in_category: categoryId }, options)
}
